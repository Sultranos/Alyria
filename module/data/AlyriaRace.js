export const race = {
    ...
    "Haut-Elfe": {
        ...
        talentRace: {
            ...
            effect:"Lors d’un jet de Persuader/Tromper contre une race non-elfique vous ajouter votre valeur de SAGESSE ou INTELLIGENCE à votre statistique.",
            },
        competenceRace: {
            nom:"Canon de verre",
    ...
    "Elfe des Bois": {
        ...
        talentRace: {
            nom:"Vie en nature",
            effect:"Ajoute +10 dans les statistiques mineures basées sur la sagesse et la dextérité si vous êtes dans un milieu forestier ou arboré.",
            },
        competenceRace: {
            nom: "Précision naturelle (Réussite automatique)",
            effect: "Vous gagnez +10 mètres de portée et +10% de chances de réussir la prochaine attaque à distance et+10% de Critique. Ne consomme pas d’action, non cumulable. Utilisable une fois par combat ou scène.",
            },
        majeures: {
            Force: 3,
            Dextérité: 5,
